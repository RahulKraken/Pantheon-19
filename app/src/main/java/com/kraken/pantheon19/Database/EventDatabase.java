...
public abstract class EventDatabase extends RoomDatabase {
    ...
    private static class InitEventDbAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            eventDao.insert(new Event(1, "event1", "desc1", "complete", "10:00", "IC", 1, flagship, 4, "Rahul"));
            eventDao.insert(new Event(2, "event2", "desc2", "complete", "11:00", "IC", 1, flagship, 4, "Rahul"));
            eventDao.insert(new Event(3, "event3", "desc3", "complete", "13:00", "IC", 2, flagship, 4, "Rahul"));
